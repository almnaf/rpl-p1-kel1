...
<body>
    ...
    if (isset($_POST["submit"])) {
        if (!isset($_POST["hidden"])) {
            ...
            $source = $_POST["source"];
            $desc = $_POST["desc"];
            $sql = "INSERT INTO `notes`(`title`, `amount`, `source`, `description`) VALUES ('$title', '$amount', '$source', '$desc')";
            ...
            <div class="col-lg-10">
                <form class="form" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="source" placeholder="Masukkan Sumber..." name="source" required>
                    </div>
